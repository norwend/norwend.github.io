...
**Учтите, что это полный гайд по прохождению игры на 100%!** Вам нужен этот гайд, если вы хотите пройти *Robotics;Notes ELITE* <ins>***и***</ins> получить все ачивки. Если вы хотите просто пройти игру, ничего не упустив, то вам нужен гайд по рутам, который можно найти [**здесь**](/posts/robotics-notes-elite-routes/).
...
> **Mr_PLEIADES:** @UMISHO Now is not the time for that! Don’t worry about nonsense!
>
